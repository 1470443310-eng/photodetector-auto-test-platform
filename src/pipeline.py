...
def execute(config_path: str | Path, output_root: str | Path = "artifacts", profiles: list[str] | None = None) -> dict:
    ...
    return {"run_id": run_id, "run_dir": run_dir, "results": results, "summary": summary, "paths": paths, "report": report}
